...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFubHViYmVycyIsImEiOiJja291Z2p4dnowaTV2MnVvN2NibTRqNjRlIn0.b83RXUmKS7mPt3xxHij3Ww';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/danlubbers/ckouh2ili172717ochi474k07',
    scrollZoom: false
  });
  ...
  }); // moves and zooms the map to fit markers
};
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              // url: 'http://127.0.0.1:3000/api/v1/users/login', // dev mode
...
var stripe = Stripe('pk_test_51IuNRgDnwabxwUC26ZJBr0u1jVACDlC255ZCXNkNoncI4f0WEnfFNZvu6dC3I7jovOOd36jxTahmXxbDb6ZPRP5w00JVfw6ojb');
...
},{"axios":"../../node_modules/axios/index.js","alerts":"../../node_modules/alerts/index.js"}],"../../node_modules/express-mongo-sanitize/index.js":[function(require,module,exports) {
'use strict';
...
function sanitize(target, options) {
  ...
  withEach(target, function (obj, val, key) {
    ...
    if (TEST_REGEX.test(key)) {
      ...
      if (replaceWith) {
        key = key.replace(REPLACE_REGEX, replaceWith); // Avoid to set __proto__ and constructor.prototype
...
if (userDataPassword) userDataPassword.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = 'Save password'; // Reset password fields. Need to use async/await for this
